                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$jumlah;?></td>
                                            <td><a href="view.php?idp=<?=$idpesanan;?>" class="btn btn-primary" target="blank">Tampilkan</a><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete<?=$idmasuk;?>">
                                                    Delete
                                                </button></td>
                                        <tr>
                                    <?php
